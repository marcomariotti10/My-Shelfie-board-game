...
import it.polimi.ingsw.server.model.commongoals.CommonGoalI;
...
class CommonGoalITest {
    ...
    void check() throws ExceededLibraryLimitException {
        CommonGoalI c = new CommonGoalI();

        matrixLibrary[0][0] = Block.BLUE;  //piena
        ...
        matrixLibrary[0][3] = Block.BLUE;  //piena
        matrixLibrary[1][3] = Block.GREEN;
        matrixLibrary[2][3] = Block.LIGHT_BLUE;
    ...
    void checkFalse() throws ExceededLibraryLimitException {
        ...
        matrixLibrary[0][1] = Block.NULL;  //piena
        ...
        matrixLibrary[0][3] = Block.NULL;  //piena
        matrixLibrary[1][3] = Block.GREEN;
        matrixLibrary[2][3] = Block.LIGHT_BLUE;
        matrixLibrary[3][3] = Block.PINK;
        matrixLibrary[4][3] = Block.WHITE;
