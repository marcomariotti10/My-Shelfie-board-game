...
import it.polimi.ingsw.server.model.commongoals.CommonGoalE;
...
class CommonGoalETest {
    ...
    void check() throws ExceededLibraryLimitException {
        CommonGoalE c = new CommonGoalE();

        matrixLibrary[0][0] = Block.BLUE;
        matrixLibrary[1][0] = Block.GREEN;
        matrixLibrary[2][0] = Block.LIGHT_BLUE;
        matrixLibrary[3][0] = Block.PINK;
        matrixLibrary[4][0] = Block.WHITE;
        matrixLibrary[5][0] = Block.ORANGE;

        matrixLibrary[0][1] = Block.LIGHT_BLUE;
        matrixLibrary[1][1] = Block.BLUE;
        matrixLibrary[2][1] = Block.PINK;
        matrixLibrary[3][1] = Block.PINK;
        matrixLibrary[4][1] = Block.PINK;
        matrixLibrary[5][1] = Block.PINK;
        ...
        matrixLibrary[0][3] = Block.GREEN;
        matrixLibrary[1][3] = Block.GREEN;
        matrixLibrary[2][3] = Block.GREEN;
        matrixLibrary[3][3] = Block.GREEN;
        matrixLibrary[4][3] = Block.GREEN;
        matrixLibrary[5][3] = Block.GREEN;

        matrixLibrary[0][4] = Block.ORANGE;
        matrixLibrary[1][4] = Block.ORANGE;
    ...
    void check1() throws ExceededLibraryLimitException {
        ...
        matrixLibrary[1][3] = Block.LIGHT_BLUE;
        matrixLibrary[2][3] = Block.ORANGE;
        matrixLibrary[3][3] = Block.LIGHT_BLUE;
        matrixLibrary[4][3] = Block.LIGHT_BLUE;
        matrixLibrary[5][3] = Block.LIGHT_BLUE;

        matrixLibrary[0][4] = Block.PINK;
        matrixLibrary[1][4] = Block.BLUE;
        matrixLibrary[2][4] = Block.GREEN;
        matrixLibrary[3][4] = Block.PINK;
        matrixLibrary[4][4] = Block.PINK;
    ...
    @Test
    void checkFalse() throws ExceededLibraryLimitException {
        CommonGoalE c = new CommonGoalE();
        ...
        matrixLibrary[0][3] = Block.LIGHT_BLUE;
        matrixLibrary[1][3] = Block.GREEN;
        matrixLibrary[2][3] = Block.GREEN;
        matrixLibrary[3][3] = Block.PINK;
        matrixLibrary[4][3] = Block.GREEN;
        matrixLibrary[5][3] = Block.ORANGE;
