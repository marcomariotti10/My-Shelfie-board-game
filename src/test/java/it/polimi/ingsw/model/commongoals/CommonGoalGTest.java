...
import it.polimi.ingsw.server.model.commongoals.CommonGoalG;
...
class CommonGoalGTest {
    ...
    void check1() throws ExceededLibraryLimitException {
        CommonGoalG c = new CommonGoalG();

        matrixLibrary[0][0] = Block.NULL;       //correct(diagonal from the left)
        matrixLibrary[0][1] = Block.NULL;
        matrixLibrary[0][2] = Block.NULL;
        matrixLibrary[0][3] = Block.NULL;
        matrixLibrary[0][4] = Block.NULL;

        matrixLibrary[1][0] = Block.PINK;
        ...
        matrixLibrary[4][2] = Block.PINK;
        matrixLibrary[4][3] = Block.PINK;
    ...
    void check2() throws ExceededLibraryLimitException {
        ...
        matrixLibrary[0][0] = Block.BLUE;       //correct(diagonal from the right)
        matrixLibrary[0][1] = Block.NULL;
        matrixLibrary[0][2] = Block.NULL;
        matrixLibrary[0][3] = Block.NULL;
        matrixLibrary[0][4] = Block.NULL;
    ...
    @Test
    void check3() throws ExceededLibraryLimitException {
        CommonGoalG c = new CommonGoalG();

        matrixLibrary[0][0] = Block.PINK;       //wrong
        matrixLibrary[0][1] = Block.NULL;
        matrixLibrary[0][2] = Block.NULL;
        matrixLibrary[0][3] = Block.NULL;
        matrixLibrary[0][4] = Block.NULL;
